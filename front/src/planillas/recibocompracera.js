export function reciboCompraCeraPDF(data = {}) {
  const {
    lugar = 'SAMAUZABETY',
    dia = '07',
    mes = '07',
  ...
  *{ font-family: DejaVu Sans, sans-serif; }
  ...
  <table class="header">
    ...
    <tr><td colspan="5" style="text-align:center; font-size:16px; font-weight:bold;">RECIBO DE COMPRA DE CERA DE ABEJA</td></tr>
    <tr><td colspan="2"><table class="table2"><tr class="dark"><th>LUGAR</th><th>DÍA</th><th>MES</th><th>AÑO</th></tr>
    <tr><td>${lugar}</td><td>${dia}</td><td>${mes}</td><td>${anio}</td></tr></table></td>
    <td colspan="2"></td>
    <td colspan="2">
        <table class="table2">
              <tr class="dark"><th>NRO DE RECIBO</th><th>FECHA DE RECIBO</th></tr>
              <tr><td>${nroRecibo}</td><td>${fechaRecibo}</td></tr>
        </table>
    </td>
  ...
  <table class="table">
    ...
    <tr><td class="label">Por la compra de:</td><td>${cantidadKg} </td><td>Kilogramos de Cera de Abeja</td></tr>
  </table>
  <br>
  <table class="table">
    <tr>
